...
# ----- Imagen Fondo -----
        ...
        Label(self.rootGUIPEM, image=self.bg).place(
...
# ***** Boton Prueba Kolmogorov *****
        BotonKo = Button(self.framePEM1, text="Kolmogorov", font=(
...
# ***** Boton Prueba Poker *****
 ...
 # ****** Frame 2 GUI Pruebas ******
        ...
        Label(self.framePEM2, text="Ingrese los datos para la prueba", font=(
        ...
        # ***** Campo a *****
        Label(self.framePEM2, text="a", font=("times", 16, "bold"),
              bg="gray18", fg="white").place(x=100, y=77)
        self.a = Entry(self.framePEM2, font=("times", 16), width=9)
        self.a.place(x=135, y=77)

        # ***** Campo Xn *****
        Label(self.framePEM2, text="Xn", font=("times", 16, "bold"),
              bg="gray18", fg="white").place(x=240, y=77)
        self.xn = Entry(self.framePEM2, font=("times", 16), width=9)
        self.xn.place(x=275, y=77)

        # ***** Campo M *****
        Label(self.framePEM2, text="M", font=("times", 16, "bold"),
              bg="gray18", fg="white").place(x=365, y=77)
