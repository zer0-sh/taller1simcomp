...
# ****** Frame 1 GUI Lineal Congruente ******
        ...
        Label(self.frameLC1, text="Definido por la relación de recurrencia:", font=(
            "times", 13, ), bg="gray18", fg="white").place(x=45, y=100)
        Label(self.frameLC1, text="Xn+1 = (a . Xn + C)mod m; X0: Semilla",
              font=("times", 14, "bold"), bg="gray18", fg="navajowhite4").place(x=45, y=165)
        Label(self.frameLC1, text="Rn = Xn/m", font=("times", 14,),
              bg="gray18", fg="navajowhite4").place(x=160, y=195)
        Label(self.frameLC1, text="a: Multiplicador", font=(
            "times", 13, "bold"), bg="gray18", fg="white").place(x=25, y=250)
        Label(self.frameLC1, text="c: Incremento", font=(
            "times", 13, "bold"), bg="gray18", fg="white").place(x=25, y=275)
        Label(self.frameLC1, text="m: Módulo", font=("times", 13,
              "bold"), bg="gray18", fg="white").place(x=25, y=300)
        Label(self.frameLC1, text="Se tiene 0 <= Xn < m, por eso Rn < 1", font=(
            "times", 13, "bold"), bg="gray18", fg="white").place(x=25, y=330)
...
# ***** Boton Info *****
        BotonInfo = Button(self.frameLC1, text="i", font=(
            "times", 15), bg="Skyblue4", fg="white", bd=5, cursor="hand2", command=self.info1)
        BotonInfo.place(x=222, y=385, width=50)

# ***** Boton Estandar Minimo *****
        BotonVolv = Button(self.frameLC1, text="Estandar Mínimo", font=(
            "times", 15), bg="navajowhite4", fg="white", bd=5, cursor="hand2", command=self.abrirEM)
        BotonVolv.place(x=25, y=385, width=170)

# ***** Botón Menú Principal *****
        BotonInfo = Button(self.frameLC1, text="Menú", font=(
...
# ***** Boton generar (OK) *****
        ...
        # ***** Boton Pruebas *****
        BotonPr = Button(frameLC3, text="Pruebas", font=(
