...
# ----- Imagen Fondo -----
        ...
        Label(frameInicio, text="NÚMEROS PSEUDOALEATORIOS", font=(
            "times", 19, "bold"), bg="gray18", fg="navajowhite4").place(x=50, y=30)

        # ****** Label Info Inicial ****** #
        Label(frameInicio, text="Diseñados con el fin de generar números con un", font=(
            "times", 13, ""), bg="gray18", fg="white").place(x=43, y=100)
        Label(frameInicio, text="comportamiento similar al aleatorio.", font=(
            "times", 13, ""), bg="gray18", fg="white").place(x=43, y=122)

        # ----- icono info -----
        Label(frameInicio, text=" ✅", font=("", 35, ""),
              bg="gray18", fg="white").place(x=400, y=95)

        # ****** Label Selección ****** #
        Label(frameInicio, text="Seleccione el generador que desea emplear:", font=(
            "times", 14, ""), bg="gray18", fg="white").place(x=43, y=205)

        # ----- Boton Generador Lineal Congruente -----
        BotonLC = Button(frameInicio, text="Lineal Congruente", command=self.abrirLC, font=(
            "times", 15), bg="navajowhite4", fg="white", bd=5, cursor="hand2")
        BotonLC.place(x=162, y=253, width=200)

        # ----- Boton Generador de Estandar Mínimo -----
        BotonEM = Button(frameInicio, text="Estandar Mínimo", command=self.abrirEM, font=(
            "times", 15), bg="navajowhite4", fg="white", bd=5, cursor="hand2")
        BotonEM.place(x=162, y=323, width=200)

        # ----- Boton Generador Random de Python ----- #
        BotonSalir = Button(frameInicio, text="Python Random", command=self.abrirRandom, font=(
            "times", 15), bg="navajowhite4", fg="white", bd=5, cursor="hand2")
        BotonSalir.place(x=162, y=393, width=200)

        # ****** Boton Salir ****** #
        BotonSalir = Button(frameInicio, text="Salir", command=self.rootInicio.destroy, font=(
