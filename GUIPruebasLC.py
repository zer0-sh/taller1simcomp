...
# ----- Imagen Fondo -----
        ...
        Label(self.rootGUIP, image=self.bg).place(x=0, y=0, relwidth=1, relheight=1)
...
# ***** Labels *****
        Label(self.frameP1, text="Pruebas", font=("times", 18, "bold"), bg="gray18",fg="navajowhite4").place(x=45, y=30)



# ****** Boton Salir ****** #
        BotonSalir = Button(self.frameP1, text="Salir", command=self.rootGUIP.destroy, font=("times", 15), bg="firebrick4", fg="white", bd=5, cursor="hand2")
        BotonSalir.place(x=250, y=425, width=70)

# ***** Boton Info *****
        BotonInfo = Button(self.frameP1, text="i", font=("times", 15), bg="Skyblue4", fg="white", bd=5, cursor="hand2",command=self.info3)
        BotonInfo.place(x=20, y=425, width=50)

# ***** Botón Menú Principal *****
        BotonInfo = Button(self.frameP1, text="Menú", font=("times", 15), bg="Skyblue4", fg="white", bd=5, cursor="hand2",command=self.abrirMenu)
        BotonInfo.place(x=173, y=425, width=67)

# ***** Boton Prueba Chi *****
        BotonChi = Button(self.frameP1, text="Chi χ²", font=("times", 15), bg="navajowhite4", fg="white", bd=5,cursor="hand2", command=self.pChiCu)
        BotonChi.place(x=90, y=100, width=170)

# ***** Boton Prueba Kolmogorov *****
        BotonKo = Button(self.frameP1, text="Kolmogorov", font=("times", 15), bg="navajowhite4", fg="white", bd=5,cursor="hand2", command=self.pKolmo)
        BotonKo.place(x=90, y=160, width=170)

# ***** Boton Prueba Corridas *****
        BotonCo = Button(self.frameP1, text="Corridas", font=("times", 15), bg="navajowhite4", fg="white", bd=5,cursor="hand2", command=self.pCorridas)
        BotonCo.place(x=90, y=220, width=170)

# ***** Boton Prueba Series *****
        BotonSe = Button(self.frameP1, text="Series", font=("times", 15), bg="navajowhite4", fg="white", bd=5,cursor="hand2", command=self.pSeries)
        BotonSe.place(x=90, y=280, width=170)

# ***** Boton Prueba Poker *****
        BotonPoker = Button(self.frameP1, text="Poker", font=("times", 15), bg="navajowhite4", fg="white", bd=5,cursor="hand2", command=self.pPoker)
 ...
 # ****** Frame 2 GUI Pruebas ******
        ...
        Label(self.frameP2, text="Ingrese los datos para la prueba", font=("times", 17, "bold"), bg="gray18",fg="navajowhite4").place(x=50, y=30)
        ...
        # ***** Campo a *****
        Label(self.frameP2, text="a", font=("times", 16, "bold"), bg="gray18", fg="white").place(x=50, y=77)
        self.a = Entry(self.frameP2, font=("times", 16), width=9)
        self.a.place(x=85, y=77)

        # ***** Campo Xn *****
        Label(self.frameP2, text="Xn", font=("times", 16, "bold"), bg="gray18", fg="white").place(x=220, y=77)
        self.xn = Entry(self.frameP2, font=("times", 16), width=9)
        self.xn.place(x=255, y=77)

        # ***** Campo C *****
        Label(self.frameP2, text="C", font=("times", 16, "bold"), bg="gray18", fg="white").place(x=370, y=77)
        self.c = Entry(self.frameP2, font=("times", 16), width=9)
        self.c.place(x=405, y=77)

        # ***** Campo M *****
        Label(self.frameP2, text="M", font=("times", 16, "bold"), bg="gray18", fg="white").place(x=520, y=77)
    ...
    def pChiCu(self):
        ...
        c = int(self.c.get())
        m = int(self.m.get())
        arreglo = GeneradorLineal.GeneradorLineal.genLinCongruente(xn,xn,a,c,m)
